 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.location.LocationJsonParameterEntity")
@DiscriminatorValue("json")
public class LocationJsonParameterEntity extends LocationParameterEntity<String> implements JsonParameterEntity {
