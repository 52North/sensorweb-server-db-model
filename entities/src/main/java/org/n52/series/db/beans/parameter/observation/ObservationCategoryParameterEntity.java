...
@Entity(name = "org.n52.series.db.beans.parameter.observation.ObservationCategoryParameterEntity")
...
public class ObservationCategoryParameterEntity extends ObservationParameterEntity<String>
    ...
    @JoinColumn(name = "fk_unit_id", foreignKey = @ForeignKey(name = "fk_observation_param_unit"))
