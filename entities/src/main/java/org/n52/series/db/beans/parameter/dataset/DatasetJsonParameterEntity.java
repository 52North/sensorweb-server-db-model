 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.dataset.DatasetJsonParameterEntity")
@DiscriminatorValue("json")
public class DatasetJsonParameterEntity extends DatasetParameterEntity<String> implements JsonParameterEntity {
