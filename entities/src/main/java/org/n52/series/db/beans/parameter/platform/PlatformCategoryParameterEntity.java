...
@Entity(name = "org.n52.series.db.beans.parameter.platform.PlatformCategoryParameterEntity")
@DiscriminatorValue("category")
public class PlatformCategoryParameterEntity extends PlatformParameterEntity<String>
    ...
    @JoinColumn(name = "fk_unit_id", foreignKey = @ForeignKey(name = "fk_platform_param_unit"))
