...
@Entity(name = "org.n52.series.db.beans.parameter.observation.ObservationQuantityParameterEntity")
@DiscriminatorValue("quantity")
public class ObservationQuantityParameterEntity extends ObservationParameterEntity<BigDecimal>
