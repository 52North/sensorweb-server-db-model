 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.procedure.ProcedureJsonParameterEntity")
@DiscriminatorValue("json")
public class ProcedureJsonParameterEntity extends ProcedureParameterEntity<String> implements JsonParameterEntity {
