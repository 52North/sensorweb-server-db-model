 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.procedure.ProcedureBooleanParameterEntity")
@DiscriminatorValue("bool")
public class ProcedureBooleanParameterEntity extends ProcedureParameterEntity<Boolean>
