 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.platform.PlatformBooleanParameterEntity")
@DiscriminatorValue("bool")
public class PlatformBooleanParameterEntity extends PlatformParameterEntity<Boolean>
