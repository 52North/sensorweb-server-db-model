...
public class PartyComplexParameterEntity extends PartyParameterEntity<Set<PartyParameterEntity<?>>>
        implements ComplexParameterEntity<Set<PartyParameterEntity<?>>> {
