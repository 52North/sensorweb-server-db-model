...
@Entity(name = "org.n52.series.db.beans.parameter.phenomenon.PhenomenonCategoryParameterEntity")
...
public class PhenomenonCategoryParameterEntity extends PhenomenonParameterEntity<String>
    ...
    @JoinColumn(name = "fk_unit_id", foreignKey = @ForeignKey(name = "fk_phenomenon_param_unit"))
