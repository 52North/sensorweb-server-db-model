 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.platform.PlatformCountParameterEntity")
@DiscriminatorValue("count")
public class PlatformCountParameterEntity extends PlatformParameterEntity<Integer> implements CountParameterEntity {
