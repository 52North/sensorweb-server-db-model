 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.feature.FeatureXmlParameterEntity")
@DiscriminatorValue("xml")
public class FeatureXmlParameterEntity extends FeatureParameterEntity<String> implements XmlParameterEntity {
