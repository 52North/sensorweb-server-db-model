 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.observation.ObservationXmlParameterEntity")
@DiscriminatorValue("xml")
public class ObservationXmlParameterEntity extends ObservationParameterEntity<String> implements XmlParameterEntity {
