...
@Entity(name = "org.n52.series.db.beans.parameter.feature.FeatureCategoryParameterEntity")
...
public class FeatureCategoryParameterEntity extends FeatureParameterEntity<String> implements CategoryParameterEntity {
    ...
    @JoinColumn(name = "fk_unit_id", foreignKey = @ForeignKey(name = "fk_feature_param_unit"))
