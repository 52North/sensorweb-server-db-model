 ...
 */
@Entity(name = "org.n52.series.db.beans.parameter.platform.PlatformJsonParameterEntity")
@DiscriminatorValue("json")
public class PlatformJsonParameterEntity extends PlatformParameterEntity<String> implements JsonParameterEntity {
