...
public class GroupComplexParameterEntity extends GroupParameterEntity<Set<GroupParameterEntity<?>>>
        implements ComplexParameterEntity<Set<GroupParameterEntity<?>>> {

    private static final long serialVersionUID = -5166758396873257962L;

    @Override
    public Set<GroupParameterEntity<?>> getValue() {
        return super.getValue();
    }

    @Override
    public void setValue(Set<GroupParameterEntity<?>> value) {
