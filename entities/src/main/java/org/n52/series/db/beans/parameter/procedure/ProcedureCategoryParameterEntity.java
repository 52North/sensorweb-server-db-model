...
@Entity(name = "org.n52.series.db.beans.parameter.procedure.ProcedureCategoryParameterEntity")
@DiscriminatorValue("category")
public class ProcedureCategoryParameterEntity extends ProcedureParameterEntity<String>
    ...
    @JoinColumn(name = "fk_unit_id", foreignKey = @ForeignKey(name = "fk_procedure_param_unit"))
