...
/**
 * QBlobDatasetEntity is a Querydsl query type for BlobDatasetEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QBlobDatasetEntity extends EntityPathBase<BlobDatasetEntity> {

    private static final long serialVersionUID = 691053197L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBlobDatasetEntity blobDatasetEntity = new QBlobDatasetEntity("blobDatasetEntity");
    ...
    public QBlobDatasetEntity(String variable) {
        this(BlobDatasetEntity.class, forVariable(variable), INITS);
    }

    public QBlobDatasetEntity(Path< ? extends BlobDatasetEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QBlobDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QBlobDatasetEntity(PathMetadata metadata, PathInits inits) {
        this(BlobDatasetEntity.class, metadata, inits);
    }

    public QBlobDatasetEntity(Class< ? extends BlobDatasetEntity> type, PathMetadata metadata, PathInits inits) {
