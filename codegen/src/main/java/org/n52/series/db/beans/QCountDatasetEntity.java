...
/**
 * QCountDatasetEntity is a Querydsl query type for CountDatasetEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QCountDatasetEntity extends EntityPathBase<CountDatasetEntity> {

    private static final long serialVersionUID = 1259364061L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCountDatasetEntity countDatasetEntity = new QCountDatasetEntity("countDatasetEntity");
    ...
    public QCountDatasetEntity(String variable) {
        this(CountDatasetEntity.class, forVariable(variable), INITS);
    }

    public QCountDatasetEntity(Path<? extends CountDatasetEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCountDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCountDatasetEntity(PathMetadata metadata, PathInits inits) {
        this(CountDatasetEntity.class, metadata, inits);
    }

    public QCountDatasetEntity(Class<? extends CountDatasetEntity> type, PathMetadata metadata, PathInits inits) {
