...
/**
 * QTextDatasetEntity is a Querydsl query type for TextDatasetEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QTextDatasetEntity extends EntityPathBase<TextDatasetEntity> {

    private static final long serialVersionUID = -1267460355L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTextDatasetEntity textDatasetEntity = new QTextDatasetEntity("textDatasetEntity");
    ...
    public QTextDatasetEntity(String variable) {
        this(TextDatasetEntity.class, forVariable(variable), INITS);
    }

    public QTextDatasetEntity(Path<? extends TextDatasetEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QTextDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QTextDatasetEntity(PathMetadata metadata, PathInits inits) {
        this(TextDatasetEntity.class, metadata, inits);
    }

    public QTextDatasetEntity(Class<? extends TextDatasetEntity> type, PathMetadata metadata, PathInits inits) {
