...
public class QReferencedDatasetEntity extends EntityPathBase<ReferencedDatasetEntity> {

    private static final long serialVersionUID = 1365782001L;
    ...
    public QReferencedDatasetEntity(String variable) {
    ...
    public QReferencedDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QReferencedDatasetEntity(PathMetadata metadata, PathInits inits) {
