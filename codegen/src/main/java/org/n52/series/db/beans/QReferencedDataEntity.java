...
/**
 * QReferencedDataEntity is a Querydsl query type for ReferencedDataEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QReferencedDataEntity extends EntityPathBase<ReferencedDataEntity> {

    private static final long serialVersionUID = 1694799991L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QReferencedDataEntity referencedDataEntity = new QReferencedDataEntity("referencedDataEntity");
    ...
    public QReferencedDataEntity(String variable) {
        this(ReferencedDataEntity.class, forVariable(variable), INITS);
    }

    public QReferencedDataEntity(Path<? extends ReferencedDataEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QReferencedDataEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QReferencedDataEntity(PathMetadata metadata, PathInits inits) {
        this(ReferencedDataEntity.class, metadata, inits);
    }

    public QReferencedDataEntity(Class<? extends ReferencedDataEntity> type, PathMetadata metadata, PathInits inits) {
