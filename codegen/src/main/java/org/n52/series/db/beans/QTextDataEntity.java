...
/**
 * QTextDataEntity is a Querydsl query type for TextDataEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QTextDataEntity extends EntityPathBase<TextDataEntity> {

    private static final long serialVersionUID = -1087624469L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTextDataEntity textDataEntity = new QTextDataEntity("textDataEntity");
    ...
    public QTextDataEntity(String variable) {
        this(TextDataEntity.class, forVariable(variable), INITS);
    }

    public QTextDataEntity(Path< ? extends TextDataEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QTextDataEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QTextDataEntity(PathMetadata metadata, PathInits inits) {
        this(TextDataEntity.class, metadata, inits);
    }
