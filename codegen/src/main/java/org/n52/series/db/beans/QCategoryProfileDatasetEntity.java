...
public class QCategoryProfileDatasetEntity extends EntityPathBase<CategoryProfileDatasetEntity> {

    private static final long serialVersionUID = -851907231L;
    ...
    public QCategoryProfileDatasetEntity(String variable) {
    ...
    public QCategoryProfileDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCategoryProfileDatasetEntity(PathMetadata metadata, PathInits inits) {
