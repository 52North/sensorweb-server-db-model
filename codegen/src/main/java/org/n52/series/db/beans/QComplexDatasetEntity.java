...
public class QComplexDatasetEntity extends EntityPathBase<ComplexDatasetEntity> {

    private static final long serialVersionUID = 2036756636L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QComplexDatasetEntity complexDatasetEntity = new QComplexDatasetEntity("complexDatasetEntity");
    ...
    public QComplexDatasetEntity(String variable) {
    ...
    public QComplexDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QComplexDatasetEntity(PathMetadata metadata, PathInits inits) {
