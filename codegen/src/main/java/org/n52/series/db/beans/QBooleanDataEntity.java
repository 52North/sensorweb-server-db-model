...
/**
 * QBooleanDataEntity is a Querydsl query type for BooleanDataEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QBooleanDataEntity extends EntityPathBase<BooleanDataEntity> {

    private static final long serialVersionUID = -233742556L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBooleanDataEntity booleanDataEntity = new QBooleanDataEntity("booleanDataEntity");
    ...
    public QBooleanDataEntity(String variable) {
        this(BooleanDataEntity.class, forVariable(variable), INITS);
    }

    public QBooleanDataEntity(Path< ? extends BooleanDataEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QBooleanDataEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QBooleanDataEntity(PathMetadata metadata, PathInits inits) {
        this(BooleanDataEntity.class, metadata, inits);
    }

    public QBooleanDataEntity(Class< ? extends BooleanDataEntity> type, PathMetadata metadata, PathInits inits) {
