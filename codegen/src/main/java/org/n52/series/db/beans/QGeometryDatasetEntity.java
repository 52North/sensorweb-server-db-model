...
public class QGeometryDatasetEntity extends EntityPathBase<GeometryDatasetEntity> {

    private static final long serialVersionUID = -1877435304L;
    ...
    public QGeometryDatasetEntity(String variable) {
    ...
    public QGeometryDatasetEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QGeometryDatasetEntity(PathMetadata metadata, PathInits inits) {
