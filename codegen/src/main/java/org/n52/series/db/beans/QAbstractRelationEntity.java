...
public class QAbstractRelationEntity
        extends EntityPathBase<AbstractRelationEntity<org.n52.series.db.beans.ereporting.EReportingDatasetEntity>> {

    private static final long serialVersionUID = -1318847886L;

    public static final QAbstractRelationEntity abstractRelationEntity =
            new QAbstractRelationEntity("abstractRelationEntity");
